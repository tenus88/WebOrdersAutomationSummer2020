package com.webborders.utilities;
...
public class Driver {
    ...
    //if reference variable does not point at any object it will have a null value
    //whenever we type new Class() - we create a new object
    //reference type can be class, parent class or interface implementes by class or parent class
    //since WebDriver is an interface implemented by RemoteWebDriver class
    //and RemoteWebDriver is a parent class of ChromDriver, FirefoxDriver....
